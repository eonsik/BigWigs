...
--L.guildRelease = "당신은 현재 공식 버전 %d을(를) 기준으로 당신의 길드를 위해 만들어진 길드용 빅위그 버전 %d을(를) 실행하고 있습니다."
...
--L.warnOldBase = "당신은 현재 길드 버전의 BigWigs(%d)를 사용하고 있지만 베이스 버전(%d)이 최신 버전이 아닌 %d 릴리스입니다. 이로 인해 문제가 발생할 수 있습니다.."
